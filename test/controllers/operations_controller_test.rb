...
class OperationsControllerTest < ActionController::TestCase
  ...
  test "should create operation" do
    assert_difference('Operation.count') do
      post :create, operation: { firstOp: @operation.firstOp, responseTime: @operation.responseTime, secondOp: @operation.secondOp, type: @operation.type }
    end
  ...
  test "should update operation" do
    patch :update, id: @operation, operation: { firstOp: @operation.firstOp, responseTime: @operation.responseTime, secondOp: @operation.secondOp, type: @operation.type }
    assert_redirected_to operation_path(assigns(:operation))
  end
